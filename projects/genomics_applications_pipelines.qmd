...
-   Unit-tested Python and command line tools transform the variant calls into interactive genomic reports (IGV and JSON), following software development best practices and FAIR principles.

-   Automated QC and reporting workflows built with Quarto curate the variant and expression outputs and flag outliers or inconsistent samples and batches.
