...
Other nextflow pipelines generated with nextflow and nf-core tools include CutandRun heatmaps (AKA tornado plots), VCF variant annotations, and splitting ATAC-seq bams by fragment size.   
