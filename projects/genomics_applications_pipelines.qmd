...
Use of github actions and Gitpod with DevContainers are able to automate tasks, like testing, as well as create shareable and reproducible development environments. Reproducible development environments allow team members to actively contribute to a shared code repository, including potential data analysis tasks or genomics pipelines.

## Github Actions

Personal website found [here](https://github.com/jennylsmith/jennylsmith.github.io)

-   Uses a commit trigger and github hosted runners to build the website from a clone of the repository

## Gitpod Development Environment

DevOps for Data Science labs [github repository](https://github.com/jennylsmith/do4ds_labs) using
