...
-   Developed, deployed, and maintained scalable Nextflow DSL2 pipelines for long-read Nanopore WGS, bulk RNA-seq, and exome-enriched RNA-seq, producing QC reports, gene expression matrices, fusion calls, SNVs, CNVs, structural variants, and DNA methylation quantification.
...
-   Integrated an Ensembl SQLite relational database into automated cohort reports, using SQL to join variant calls with gene annotations.
...
+-----------------------+-----------------------------+--------------------------------------------------------------------------------------------------------------+
| Nextflow              | Advanced                    | -   modularized scientific workflows using domain-specific language (DSL2) syntax                            |
|                       |                             |                                                                                                              |
...
+-----------------------+-----------------------------+--------------------------------------------------------------------------------------------------------------+
| CI / CD               | Competent                   | -   development of CI/CD plans using Atlassian `bamboo` agent                                                |
|                       |                             |                                                                                                              |
