...
|                               |                             |                                                                                                                                       |
|                               |                             | -   implemented CI/CD functional tests for Nextflow workflows                                                                         |
|                               |                             |                                                                                                                                       |
...
|                               |                             |     -   scheduled tasks                                                                                                               |
+-------------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------+
| SQL                           | Competent / Being Developed | -   complex queries and database operations, such as filtering and joins, using tidyverse syntax and conversion to SQL using `dbplyr` |
|                               |                             |                                                                                                                                       |
|                               |                             | -   SQL scripting and `mysql` CLI skills being developed                                                                              |
+-------------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------+
...
-   Nextflow NF-Core Hackathon, University of Washington, March 2024

-   IGNITE speaker to promote gender equity in STEM, Seattle Children's, February 2024
