...
-   Built interactive Quarto reports and dashboards that surface variant calls through IGV genomic tracks and ProteinPaint visualizations, giving investigators a single place to review and act on results. Replaced manual curation of three variant detection methods (SV, SNV, CNA) across two sequencing technologies for a retrospective cohort of over 100 T-ALL patients.

-   Single cell and bulk RNA-seq analysis for rhabdomyosarcoma (RMS) therapeutic target discovery, with cell type classification using Seurat RPCA label transfer and SingleR, followed by Leiden clustering, UMAP, and multi-sample integration of PDX and patient cohorts.
...
|                       |                             |                                                                                                              |
|                       |                             | -   interactive variant reporting with Quarto dashboards, IGV tracks, and ProteinPaint                       |
+-----------------------+-----------------------------+--------------------------------------------------------------------------------------------------------------+
...
|                       |                             |                                                                                                              |
|                       |                             | -   automated rendering of Quarto analysis reports as part of the pipeline run                               |
+-----------------------+-----------------------------+--------------------------------------------------------------------------------------------------------------+
